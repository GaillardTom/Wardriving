...
const App = () => {
    ...
    return (
        <>
            <CssBaseline />
            <Header searchUpdate={handleSearchMarker} searchState={UpdateBooly} setSecurityBool={handleSecurityBoolChange} displayDetailsBool={handleDisplayDetailsChange} security={handleSecurityChange} packetsBoolChange={handleShowPacketsChange}/>
            <Grid container spacing={3} style={{ width: '100%' }}>
                ...
                <Grid item xs={12} md={8}>
                    <Map updateMarker={handleMarkerChange} searchState={UpdateBooly} setList={handleListChange} checkSecurityBool={securityBool} listDetails={secuList} checkSecurity={security} displayDetailsBool={handleDisplayDetailsChange} searchUpdate={updateMarker} displayDetails={displayDetails} packetsBoolChange={handleShowPacketsChange}/>
                </Grid>
            </Grid>
            <ToastContainer />
        </>
