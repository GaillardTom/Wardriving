...
const { connectCallBack, UploadCsvToDB, UploadWigleToDB, GetDevicesByMACFromDB, GetAllDeviceForMap, UploadNetxmlCSVToDB, GetAllLocationsForMap, WriteJSONFile, GetDevicesByMac } = require('./database');
